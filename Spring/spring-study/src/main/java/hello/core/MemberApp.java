...
/*//        MemberService memberService = new MemberServiceImpl();  //only java code
        ...
        MemberService memberService = applicationContext.getBean("memberService", MemberService.class);//기본적으로 Bean이름은 메서드명으로 지정이됨
